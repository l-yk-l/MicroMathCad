...
victim = function.Victim(plt, ax, start_x=0, start_y=0, direction=30, speed=0.3, max_angle_of_rotation=45, angle_of_vision=30, len_of_vision=10)
hunter1 = function.Hunter(plt, ax, start_x=-4, start_y=2, direction=-10, speed=0.5, max_angle_of_rotation=10, angle_of_vision=30, len_of_vision=10)
